...
actual class P2pManager actual constructor() {
    ...
    actual fun startAdvertising(name: String) {
        println("[Android P2P] startAdvertising: $name")
    }

    actual fun startDiscovery(name: String) {
        println("[Android P2P] startDiscovery")
        // Simulate finding a peer
        _discoveredEndpoints.value = listOf(P2pEndpoint("android_peer_1", "Android Test Peer (Meshtastic)"))
    }

    actual fun requestConnection(endpointId: String) {
        println("[Android P2P] requestConnection: $endpointId")
    ...
    actual fun sendData(data: String) {
        println("[Android P2P] sendData: $data")
    }
