...
actual class P2pManager actual constructor() {
    ...
    actual fun startAdvertising(name: String) {
        println("[Desktop P2P] startAdvertising: $name")
    }

    actual fun startDiscovery(name: String) {
        println("[Desktop P2P] startDiscovery")
        _discoveredEndpoints.value = listOf(P2pEndpoint("desktop_peer_1", "Desktop Test Peer (Meshtastic)"))
    }

    actual fun requestConnection(endpointId: String) {
        println("[Desktop P2P] requestConnection: $endpointId")
    ...
    actual fun sendData(data: String) {
        println("[Desktop P2P] sendData: $data")
    }
